    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
        <div className="ec-surface p-6">
          <h3 className="text-white  text-lg mb-2 tracking-wide uppercase">Recent Orders</h3>
        ...
        <div className="ec-surface p-6">
          <h3 className="text-white  text-lg mb-2 tracking-wide uppercase">Addresses</h3>
